            ...
            <TrackVisibility>
              ...
              <div className={isVisible ? "animate__animated animate__fadeIn" : ""}>
                ...
                <h1>{`Hi! I'm Mukul, A`} <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "Full Stack Developer", "Web Designer", ]'><span className="wrap">{text}</span></span></h1>
                  <p>Highly motivated software developer with {experience} years of experience, currently working at MNC. I possess strong skills in both frontend and backend development, with expertise in React.js, Next.js, HTML, CSS, JavaScript, Bootstrap, Node.js, Java, SpringBoot and MySQL.</p>
